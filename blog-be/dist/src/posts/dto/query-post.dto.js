...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Search term for title or slug' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], QueryPostDto.prototype, "q", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by status', enum: ['draft', 'published'] }),
